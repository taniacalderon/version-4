	...
	if(isset($_SESSION['carrito'])){
		if(isset($_GET['id'])){
					...
					if($encontro==true){
						...
						$precio=0;
						$imagen="";
						//$re=mysqli_query("select * from producto where ID=".$_GET['id']);
...
<body>
	<header
		<img src="../views/subir/uploads/logo.png" id="logo">
		<a href="../tasnego/carritodecompras.php" title="ver carrito de compras">
			<img src="../views/img/carrito.png">
		</a>
	</header>
	<section>
		<?php
	...
	?>
				<div class="producto">
					<center>
						<img src="../views/subir/uploads/<?php echo $datos[$i]['Imagen'];?>"><br>
